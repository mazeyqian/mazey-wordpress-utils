 ...
 */
function setCopyBtnForAllTagP() {
  var allTagP = document.querySelectorAll('.entry-content p');
  if (!allTagP || allTagP.length === 0) return false;
  allTagP.forEach(function (p) {
 ...
 */
function setImgLazyLoadingWhenDomReady(selector) {
  if (selector === void 0) {
 ...
 */
var loadedHideHeaderInTOC = false;
/**
 ...
 */
function hideHeaderInTOC(options) {
  if (options === void 0) {
    options = {};
  }
  var _a = Object.assign({
    ...
    _b = _a.urlContainList,
    urlContainList = _b === void 0 ? [] : _b,
    headerSelector = _a.headerSelector;
  var isIncludeUrls = false;
  if (urlContainList.length === 0) {
    isIncludeUrls = true;
  } else {
    isIncludeUrls = urlContainList.some(function (urlContainString) {
      return isIncludeInUrl({
        urlContainString: urlContainString
      });
    });
  }
  var isEzTocContainerDomExist = document.querySelector('#ez-toc-container');
  var isHideHeader = isIncludeUrls || isEzTocContainerDomExist;
  var SiteHeaderDom = document.querySelector(headerSelector);
  if (!SiteHeaderDom) return false;
  // Handle Event
  function handleScroll() {
    if (!SiteHeaderDom) return;
    var scrollTop = window.pageYOffset || document.documentElement.scrollTop || document.body.scrollTop;
    var visibility = SiteHeaderDom.style.visibility;
    if (scrollTop > 100) {
  ...
  if (isHideHeader && SiteHeaderDom && loadedHideHeaderInTOC === false) {
    // Listen
    window.addEventListener('scroll', mazey.throttle(handleScroll, 50, {
      leading: true
    }));
...
function hideSidebar(options) {
  ...
  var _a = Object.assign({
    ...
    _b = _a.urlContainList,
    urlContainList = _b === void 0 ? [] : _b,
    primarySelector = _a.primarySelector,
    secondarySelector = _a.secondarySelector;
  var isHideSidebar = urlContainList.some(function (urlContainString) {
    return isIncludeInUrl({
      urlContainString: urlContainString
    });
  });
  var secondaryDom = document.querySelector(secondarySelector);
  if (!secondaryDom) return false;
  var primaryDom = document.querySelector(primarySelector);
 ...
 */
function isIncludeInUrl(options) {
  if (options === void 0) {
    options = {};
  }
  var _a = Object.assign({
      urlContainString: ''
    }, options).urlContainString,
    urlContainString = _a === void 0 ? '' : _a;
...
function setImgWidthHeight() {
  ...
  if ($) {
    $('img').each(function () {
      ...
      if (!src) return;
      var width = src.match(/width=([0-9]+[a-z%]+)/);
      var height = src.match(/height=([0-9]+[a-z%]+)/);
...
exports.hideHeaderInTOC = hideHeaderInTOC;
exports.hideSidebar = hideSidebar;
exports.isIncludeInUrl = isIncludeInUrl;
exports.setCopyBtnForAllTagP = setCopyBtnForAllTagP;
exports.setImgLazyLoadingWhenDomReady = setImgLazyLoadingWhenDomReady;
exports.setImgWidthHeight = setImgWidthHeight;
