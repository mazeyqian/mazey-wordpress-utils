 ...
 */
function hideHeaderInTOC(_a) {
  var _b = (_a === void 0 ? {} : _a).urlContainList,
    urlContainList = _b === void 0 ? ['urlContainListDefaultValue'] : _b;
  var isIncludeUrls = urlContainList.some(function (urlContainString) {
  ...
  var SiteHeaderDom = document.querySelector('.site-header');
  // Handle Event
 ...
 * @return {Boolean} true or false
 */
function hideSidebar(_a) {
  var _b = (_a === void 0 ? {} : _a).urlContainList,
    urlContainList = _b === void 0 ? ['hide_sidebar'] : _b;
 ...
 * @return {Boolean} true or false
 */
function isIncludeInUrl(_a) {
  var _b = (_a === void 0 ? {} : _a).urlContainString,
    urlContainString = _b === void 0 ? '' : _b;
